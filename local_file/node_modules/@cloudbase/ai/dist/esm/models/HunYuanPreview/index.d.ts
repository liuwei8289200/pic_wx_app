...
import type { HunYaunGenerateTextOutput, HunYaunStreamTextOutput } from './type';
import type { ChatModel, StreamTextResult, ModelReq, BaseChatModelInput } from '../../type';
export declare class HunYuanPreviewModel implements ChatModel {
    private req;
    baseUrl: string;
    subUrl: string;
    ...
    generateText(data: BaseChatModelInput): Promise<{
        text: string;
        rawResponse: HunYaunGenerateTextOutput;
    }>;
    streamText(data: BaseChatModelInput): Promise<HunyuanModelStreamResult>;
    private processInput;
}
declare class HunyuanModelStreamResult implements StreamTextResult {
    ...
    get dataStream(): import("../../type").AsyncIterableReadableStream<HunYaunStreamTextOutput>;
